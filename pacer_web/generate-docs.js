...
const openapiSpecification = swaggerJsdoc({
  apis: ["./server/api-v2.js", "./api.yml"],
  definition: {
    openapi: "3.1.0",
    info: {
      title: "PACER Webservice API Documentation",
      version,
      description:
        "PACER Webservice transforms Building Energy Models (BEMs) into virtual buildings by providing industry standard building control interfaces for interacting with models as they run",
      "x-logo": {
    ...
    tags: [
      {
        name: "About",
        description: "Operations related to the status of PACER Webservice"
      },
      {
        name: "Alias",
