# start the measure
class PACERSetpointControl < OpenStudio::Measure::EnergyPlusMeasure

  # human readable name
  def name
    # Measure name should be the title case of the class name.
    return 'PACER Setpoint Control'
  end

  # human readable description
  def description
    return 'Add Setpoint Control to PACER'
  end
...
PACERSetpointControl.new.registerWithApplication
