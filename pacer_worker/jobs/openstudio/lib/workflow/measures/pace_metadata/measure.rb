# start the measure
require 'json'
class PACERMetadata < OpenStudio::Measure::EnergyPlusMeasure

  # human readable name
  def name
    # Measure name should be the title case of the class name.
    return 'PACER Metadata'
  end

  # human readable description
  def description
    return 'Generate metadata report for PACER'
  end
...
PACERMetadata.new.registerWithApplication
